...
window.jQuery = (jquery__WEBPACK_IMPORTED_MODULE_0___default()); // Foundation JS relies on a global variable. In ES6, all imports are hoisted
...
Foundation.Reveal.defaults.vOffset = 0; // Reveal closeOnEsc and closeOnClick are both true 
...
Foundation.Abide.defaults['validators']['checked_required'] = function ($el, required, parent) {
  ...
  if (checked >= min && checked <= max) {
    ...
    group.find('label').each(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('is-invalid-label');
    });
    group.find('[data-abide-error]').css({
      display: 'block'
    });
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./src/assets/js/fndtn.js");
/******/ 	// This entry module used 'exports' so it can't be inlined
/******/ })()
;
//# sourceMappingURL=fndtn.js.map